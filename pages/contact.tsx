...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Shreeprasad Sonar | Contact</title>
        <meta
          name="description"
        ...
        <div className="contact-infos">
          ...
          >
            ...
            <ul>
              <motion.li variants={item}>
                <a
                  href="mailto:shreeprasadofficial@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                ...
                >
                  ...
                  shreeprasadofficial@gmail.com
                </a>
              </motion.li>
              <motion.li variants={item}>
                <Link
                  href="https://github.com/ShreeprasadSonar"
                  target="_blank"
                  rel="noreferrer"
                  onMouseEnter={() => cursorChangeHandler("hovered")}
                  onMouseLeave={() => cursorChangeHandler("")}
          ...
          >
            ...
            <ul>
              <motion.li variants={item}>
                <Link
                  href="https://www.linkedin.com/in/shreeprasadsonar/"
                  target="_blank"
                  rel="noreferrer"
                  onMouseEnter={() => cursorChangeHandler("hovered")}
                  onMouseLeave={() => cursorChangeHandler("")}
              ...
              <motion.li variants={item}>
                <Link
                  href="https://www.instagram.com/baashree/"
                  target="_blank"
                  rel="noreferrer"
                  onMouseEnter={() => cursorChangeHandler("hovered")}
                  onMouseLeave={() => cursorChangeHandler("")}
